...
def server_data(request):
    # Updating this line of code for configuring the orthanc on local.
    # if request.method == 'POST':
    if request.method in ['POST', 'GET']:
        ...
        studyDate = ''
        studyTime = ''
        # Getting the hospital name / centre name - Himanshu.
        centre_name = ''
        for i in series_ids:
            ...
            # Hospital name :
            centre_name = tags['0008,0080']['Value']
        ...
        return JsonResponse ({'study_uid': studyUID, 'series': series, 'name': name, 'id': id, 'date': studyDate, 'time': studyTime, 'centre_name': centre_name})
